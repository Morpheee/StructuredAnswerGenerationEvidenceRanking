...
@click.option("--train-ds", default="fold-0/skipped_sections_train.json",
              help="training dataset.")
@click.option("--train-corpus", default="fold-0/corpus_train.json",
              help="training corpus.")
@click.option("--val-ds", default="fold-1/skipped_sections_train.json",
              help="training dataset.")
@click.option("--val-corpus", default="fold-1/corpus_train.json",
              help="val corpus.")
@click.option("--test-ds", default="test/skipped_sections_test.json",
              help="test dataset.")
